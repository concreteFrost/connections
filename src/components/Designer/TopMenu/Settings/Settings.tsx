...
function Settings() {
  ...
  return (
    <div className={s.wrapper}>
      <div className={s.settings_icon} onClick={() => setSettingsVisible(!isSettingsVisible)}>
        <UseAnimations
          fillColor="#eb4034"
      ...
      {isSettingsVisible ? <SettingsDropdown isSettingsVisible={isSettingsVisible} setSettingsVisible={setSettingsVisible}/> : null}
    </div>
  );
}
