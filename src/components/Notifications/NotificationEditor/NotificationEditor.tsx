    ...
    <div className={s.wrapper}>
      <ul>
        <li className={s.list_item}>
          ...
          <div className={s.list_item_value}>
            <input
              ...
              onChange={(e) =>
                setCurrentNotificationProps("name", e.target.value)
              }
            />
          </div>
        </li>
        <li className={s.list_item}>
          ...
          <div className={s.list_item_value}>
            <input
              type="text"
              value={currentNotification?.description}
              onChange={(e) =>
                setCurrentNotificationProps("description", e.target.value)
              }
            />
          </div>
        </li>
        ...
        <li className={s.list_item}>
          ...
          <div className={s.list_item_value}>
            <select
              value={currentNotification?.userOrGroupId}
              onChange={(e) =>
                setCurrentNotificationProps("userOrGroupId", e.target.value)
              }
            >
        ...
        <li className={s.list_item}>
          ...
          <div className={s.list_item_value}>
            ...
            <input
              type="checkbox"
              checked={currentNotification?.notifyDashboard}
              onChange={(e) =>
                setCurrentNotificationProps(
                  "notifyDashboard",
                  !currentNotification?.notifyDashboard
                )
              }
            />
            <label>Email:</label>
            <input
              type="checkbox"
              checked={currentNotification?.notifyByEmail}
              onChange={(e) =>
                setCurrentNotificationProps(
                  "notifyByEmail",
                  !currentNotification?.notifyByEmail
                )
              }
            />
            <label>Sms:</label>
            <input
              type="checkbox"
              checked={currentNotification?.notifyBySMS}
              onChange={(e) =>
                setCurrentNotificationProps(
                  "notifyBySMS",
                  !currentNotification?.notifyBySMS
                )
              }
            />
          </div>
      ...
      <div className={s.message_wrapper}>
        ...
        <div className={s.message_body}>
          <textarea
            value={currentNotification?.userMessage}
            onChange={(e) =>
              setCurrentNotificationProps("userMessage", e.target.value)
            }
          ></textarea>
        </div>
      </div>
      ...
      <footer className={s.editor_footer}>
        ...
        <button
          className={s.delete_notification_btn}
          onClick={() => {
            toggleConfirmationModal(
              true,
              `Would you like to delete ${currentNotification?.name}?`
            );
