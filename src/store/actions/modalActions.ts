...
export const toggleMessageModal =
  (get: () => RFState, set: any) => (message: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
...
//UPDATE FLOW MODAL
export const toggleUpdateFlowModal =
  (get: () => RFState, set: any) => (isVisible: boolean) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        updateFlowModal: {
...
export const setUpdateFlowSubfolderName =
  (get: () => RFState, set: any) => (subfolder: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        updateFlowModal: {
...
export const setUpdateFlowModalSaveChanges =
  (get: () => RFState, set: any) => (saveChanges: boolean) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        updateFlowModal: {
...
export const toggleLoadFlowModal =
  (get: () => RFState, set: any) => (isVisible: boolean) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
...
export const setUpdateFlowModalFlowIdToLoad =
  (get: () => RFState, set: any) => (flowId: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        updateFlowModal: {
...
export const setUpdateFlowModalActions =
  (get: () => RFState, set: any) =>
  (actions: { save: (args: any) => void; discard: (args: any) => void }) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        updateFlowModal: {
...
//Approve Modal
export const toggleApproveFlowModal =
  (get: () => RFState, set: any) =>
  (isVisible: boolean, draftIdToApprove: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        approveFlowModal: {
...
export const setApproveFlowModalMessage =
  (get: () => RFState, set: any) => (message: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
...
export const toggleCreateTemplateFlowModal =
  (get: () => RFState, set: any) =>
  (isVisible: boolean, liveFlowID?: string, liveFlowName?: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
...
export const toggleConfirmationModal =
  (get: () => RFState, set: any) => (isVisible: boolean, message: string) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        confirmationModal: {
...
export const setConfirmationModalActions =
  (get: () => RFState, set: any) => (action: any) => {
    set((state: RFState) => ({
      modalWindowsSlice: {
        ...state.modalWindowsSlice,
        confirmationModal: {
