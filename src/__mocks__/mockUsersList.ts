...
export const mockedUsers: Array<User> = [
  {
    userId: "10f2ae8c-5ac5-40b0-a5c1-9d2e13952da2",
    userLogin: "testUser",
    userName: "test user",
    isActive: true,
    ...
    dateCreated: "2024-05-31T15:13:05.473",
    lastUpdated: "2024-07-05T12:26:32.5",
    belongsToGroups: [
      {
    ...
    userRoles: [
      ...
      },
      {
        ...
        roleDescription: "User can stop, start or kill the Connections Engine",
      },
      {
        roleId: 512,
  ...
  },
  {
    ...
    lastUpdated: "2024-07-05T16:29:31.083",
    belongsToGroups: [
      {
        groupId: "6bfd9258-0c22-4515-a605-aefad52858a2",
        name: "AllNotificationsGroup",
