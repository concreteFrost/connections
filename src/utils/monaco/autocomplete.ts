...
export function cSharpAutocomplete(range: any) {
  return [
    //#region  Connections
    {
      label: "Scripting.DateConvert",
      kind: monaco.languages.CompletionItemKind.Function,
      insertText:
        "CN.Connections.Scripting.DateConvert(${1:inputNode}, ${2:returnFourDigitYear})",
      insertTextRules:
        monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
      detail:
        "Date node to String\n\nParameters:\n- inputNode: Node\n- returnFourDigitYear: boolean",
      documentation:
        "Returns the date string in yy-mm-dd or yyyy-mm-dd format for a input node value",
      range,
    },
    {
      label: "Scripting.DBLookup",
      kind: monaco.languages.CompletionItemKind.Function,
      insertText: "Scripting.DBLookup(${1:inputNode})",
      insertTextRules:
        monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
      detail: "Node Database Lookup",
      documentation:
        "Checks database for the existence of the value in the supplied inputNode",
      range,
    },
    {
      label: ".stdTemplate",
      kind: monaco.languages.CompletionItemKind.Event,
      insertText: ["skipcheck;", "", "...", "", "feeders;", "", "..."].join(
        "\n"
      ),
      insertTextRules:
        monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
    ...
    },
    {
      ...
      insertText: ["public class ${1:ClassName} {", "\t$0", "}"].join("\n"),
      insertTextRules:
        monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
      range: range,
    },
    {
      ...
      insertText: ["namespace ${1:NamespaceName} {", "\t$0", "}"].join("\n"),
      insertTextRules:
        monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet,
      range: range,
    },
